...
var ballX = (canvas.width - ballWidth)/2;
...
function drawBall() {  //always begins with beginPath and ends closePath
    ...
    ctx.beginPath();
    ctx.rect(x, y, 10,20); //first values are x and y coordinates of the arcs centre. Arc is circle. Then start and end angle
...
function draw() {
    ...
    if(rightPressed) {       //this will move the paddle 7 pixels to right and stops it disappearing off edge of canvas                                                                                                                                                                                                                                                                                                                                                                                                                                                               b) {
        x+= 2; 
    } else if(leftPressed) {
        x -=2;
    }
